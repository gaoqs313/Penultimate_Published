...
$dir="/scratch_space/qgao/Penultimate/9.lastnon/human_Shorter";
open(OUT, ">pen_short.txt");
...
open(REF, "/scratch_space/qgao/Penultimate/1.reference/human/E_MISO/Shorter/penultimate_shorter.novelty.txt");
while(<REF>)
{
        chomp;
        @l = split(/\t/,);

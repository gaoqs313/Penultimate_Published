...
$dir="/scratch_space/qgao/Penultimate/9.lastnon/Shorter";
...
open(REF, "/scratch_space/qgao/Penultimate/1.reference/mouse/F_MISO/Shorter/penultimate_shorter.novelty.txt");
while(<REF>)
{
        chomp;
        @l = split(/\t/,);

...
open(OUT,">mm10.SE.3N.gff3");
open(OUT2,">mm10.SE.3N.intron.bed");
open(OUT3, ">penultimate_3N.novelty.txt");

open(IN, "/scratch_space/qgao/Penultimate/1.reference/mouse/E_Annotation/3N/StopCodonInLastExon.final.3N.Mus_musculus.GRCm38.98.chr.gtf");
while(<IN>)
{
	chomp;
	@l=split(/\t/,);

...
open(IN, "/scratch_space/qgao/Penultimate/1.reference/mouse/E_Annotation/Eligibile/StopCodonInLastExon.final.Mus_musculus.GRCm38.98.chr.gtf");
while(<IN>)
{
	chomp;
	@l=split(/\t/,);
...
open(IN, "/scratch_space/qgao/Penultimate/1.reference/mouse/E_Annotation/Eligibile/StopCodonInPenultimateExon.final.Mus_musculus.GRCm38.98.chr.gtf");
while(<IN>)
{
        chomp;
        @l=split(/\t/,);

...
open(MM, "/research/rgs01/scratch/users/qgao/Penultimate/7.figures/mouse_support_info.txt");
<MM>;
while(<MM>)
{
	chomp;
...
open(HH, "/research/rgs01/scratch/users/qgao/Penultimate/7.figures/human_support_info.txt");
<HH>;
while(<HH>)
{
        chomp;

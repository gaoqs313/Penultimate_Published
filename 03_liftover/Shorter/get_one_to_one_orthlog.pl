...
open(MM, "/scratch_space/qgao/Penultimate/11.revision/B_Mouse_Penultimate_vs_Internal/mouse_short_support_info.txt");
<MM>;
while(<MM>)
{
	chomp;
...
open(HH, "/scratch_space/qgao/Penultimate/11.revision/C_Human_Penultimate/human_short_support_info.txt");
<HH>;
while(<HH>)
{
        chomp;

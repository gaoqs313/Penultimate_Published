...
open(MM, "/scratch_space/qgao/Penultimate/11.revision/A_Mouse_Penultimate/mouse_support_info.txt");
<MM>;
while(<MM>)
{
	chomp;
...
open(HH, "/scratch_space/qgao/Penultimate/11.revision/C_Human_Penultimate/human_support_info.txt");
<HH>;
while(<HH>)
{
        chomp;

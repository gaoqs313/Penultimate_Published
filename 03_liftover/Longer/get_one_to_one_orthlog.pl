...
open(MM, "/research/rgs01/scratch/users/qgao/Penultimate/1.reference/mouse/TEST/penultimate_shorter.novelty.txt");
while(<MM>)
{
        chomp;
        @l = split(/\t/,);
...
open(HH, "/research/rgs01/scratch/users/qgao/Penultimate/1.reference/human/TEST/penultimate_shorter.novelty.txt");
while(<HH>)
{
        chomp;
        @l = split(/\t/,);

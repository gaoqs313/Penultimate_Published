...
$dir="/scratch_space/qgao/Penultimate/6.internal/mouse";
open(OUT, ">internal_psi.txt");
...
open(REF, "/scratch_space/qgao/Penultimate/1.reference/mouse/B_MISO/filtered.internal.novelty.txt");
while(<REF>)
{
        chomp;
        @l = split(/\t/,);
